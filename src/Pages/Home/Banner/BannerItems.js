...
const BannerItems = ({ slide }) => {
  ...
  return (
    <div id={`slide${id}`} className="carousel-item relative w-full ">
      ...
      <div className="sm:hidden lg:block absolute flex justify-end w-1/2 transform -translate-y-1/4 left-10 top-1/2 ">
      ...
      <div className="absolute flex justify-end transform -translate-y-1/2 left-10 top-2/3 ">
        ...
        <button className="btn btn-outline btn-warning">Last Project</button>
      </div>
